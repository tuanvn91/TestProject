...
import com.tadfas.testproject.databinding.FragmentSearchBinding;
...
public class SearchFragment extends Fragment /*BaseListFragment<SearchInfo, ListExtractor.InfoItemsPage<?>>*/
...
//    private HistoryRecordManager historyRecordManager;
    ...
    private AtomicBoolean wasLoading = new AtomicBoolean();
...
//        showRemoteSuggestions = NewPipeSettings.showRemoteSearchSuggestions(requireActivity(), prefs);
        ...
        suggestionListAdapter = new SuggestionListAdapter(requireActivity());
...
//        super.initViews(rootView, savedInstanceState);
    ...
    public void onCreateOptionsMenu(@NonNull final Menu menu,
        ...
        final ActionBar supportActionBar = requireActivity().getSupportActionBar();
    ...
    private void showKeyboardSearch() {
        ...
        if (searchEditText.requestFocus()) {
            final InputMethodManager imm = ContextCompat.getSystemService(requireActivity(),
        ...
        try {
            ...
            if (streamingService != null) {
                ...
                disposables.add(Observable
                        .fromCallable(() -> NavigationHelper.getIntentByLink(requireActivity(),
